...
const TRANSLATIONS = {
  ...
  sec_tests: { en: '27/27 Tests Passing', tr: '27/27 Test Geçiyor', es: '27/27 Tests Pasando', pt: '27/27 Testes Passando', fr: '27/27 Tests Réussis', de: '27/27 Tests bestanden', ru: '27/27 тестов пройдено', zh: '27/27 测试通过', ja: '27/27テスト合格', ko: '27/27 테스트 통과' },
  ...
  phase1_desc: {
    en: 'Smart contract built with Anchor framework. 27/27 tests passing. Mint mechanics, vault system, LP lock, pause/unpause, 2-step authority transfer, on-chain price oracle, and metadata updates — all implemented and verified.',
    tr: 'Anchor framework ile oluşturulmuş akıllı sözleşme. 27/27 test geçti. Mint mekaniği, kasa sistemi, LP kilidi, durdurma/başlatma, 2 aşamalı yetki transferi, zincir üstü fiyat oracle\'ı ve metadata güncellemeleri — tümü uygulandı ve doğrulandı.',
    es: 'Contrato inteligente construido con el framework Anchor. 27/27 pruebas pasando. Mecánica de mint, sistema de bóveda, bloqueo LP, pausa/reanudación, transferencia de autoridad en 2 pasos, oracle de precio on-chain y actualizaciones de metadata — todo implementado y verificado.',
    pt: 'Contrato inteligente construído com o framework Anchor. 27/27 testes passando. Mecânica de mint, sistema de cofre, bloqueio LP, pausa/retomada, transferência de autoridade em 2 etapas, oracle de preço on-chain e atualizações de metadata — tudo implementado e verificado.',
    fr: 'Contrat intelligent construit avec le framework Anchor. 27/27 tests réussis. Mécanique de mint, système de coffre, verrouillage LP, pause/reprise, transfert d\'autorité en 2 étapes, oracle de prix on-chain et mises à jour de métadonnées — tout mis en œuvre et vérifié.',
    de: 'Smart Contract mit dem Anchor-Framework erstellt. 27/27 Tests bestanden. Mint-Mechanik, Tresor-System, LP-Sperre, Pause/Fortsetzung, 2-Schritt-Autoritätsübertragung, On-Chain-Preisorakel und Metadaten-Updates — alles implementiert und verifiziert.',
    ru: 'Смарт-контракт построен на фреймворке Anchor. 27/27 тестов пройдено. Механика минтинга, система хранилища, LP-блокировка, пауза/возобновление, двухэтапная передача полномочий, ценовой оракул и обновление метаданных — всё реализовано и проверено.',
    zh: '使用 Anchor 框架构建的智能合约。27/27 测试通过。铸造机制、金库系统、LP 锁定、暂停/恢复、两步权限转移、链上价格预言机和元数据更新——全部实现并验证。',
    ja: 'Anchorフレームワークで構築されたスマートコントラクト。27/27テスト合格。ミントメカニクス、ボールトシステム、LPロック、一時停止/再開、2ステップ権限移転、オンチェーン価格オラクル、メタデータ更新 — すべて実装・検証済み。',
    ko: 'Anchor 프레임워크로 구축된 스마트 컨트랙트. 27/27 테스트 통과. 민트 메커니즘, 볼트 시스템, LP 잠금, 일시정지/재개, 2단계 권한 이전, 온체인 가격 오라클 및 메타데이터 업데이트 — 모두 구현 및 검증 완료.',
  },
  phase2_desc: {
